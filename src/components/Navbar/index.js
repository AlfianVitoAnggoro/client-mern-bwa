...
import { accessCategories, accessTalents, accessEvents, accessParticipant, accessPayments, accessOrders, accessOrganizers, accessAdmins } from '../../const/access';
    ...
    <Navbar bg="dark" variant="dark">
      <Container>
        ...
        <Nav className="me-auto">
          ...
          <NavLink role={role} roles={accessAdmins.lihat} action={() => navigate('/admins')}>
            Admins
          </NavLink>
